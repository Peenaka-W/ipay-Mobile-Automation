...
public final class Drivers {
  ...
  public static AppiumDriver<WebElement> createAndroidDriverForNativeApp(String deviceName, String udid, int port, String emulator) {
    try {
  ...
  public static AppiumDriver<WebElement> createAndroidDriverForWeb(String deviceName, String udid, int port, String emulator) {
    try {
      var capability = new DesiredCapabilities();
      capability.setCapability(CapabilityType.PLATFORM_NAME, Platform.ANDROID);
      capability.setCapability(MobileCapabilityType.DEVICE_NAME, deviceName);
      ...
      return new AndroidDriver<WebElement>(new URL(getConfig(ConfigJson.APPIUM_URL)), capability);
    } catch (Exception e) {
      throw new DriverInitializationException("Failed to initialize driver. Please check the desired capabilities", e);
    }
  }

  public static AppiumDriver<WebElement> createIOSDriverForNativeApp(String deviceName, String udid, int port) {
    try {
      var capability = new DesiredCapabilities();
  ...
  public static AppiumDriver<WebElement> createIOSDriverForWeb(String deviceName, String udid, int port) {
    try {
      var capability = new DesiredCapabilities();
      capability.setCapability(CapabilityType.PLATFORM_NAME, Platform.IOS);
      capability.setCapability(MobileCapabilityType.DEVICE_NAME, deviceName);
