...
import static enums.MobileFindBy.*;
import static factories.WaitFactory.explicitlyWaitForElement;
...
public class ScreenActions {
  ...
  private final Function<String, WebElement> findByXpath =
    webElement -> DriverManager.getDriver().findElementByXPath(webElement);
  ...
  private final Function<String, WebElement> findById = mobileElement -> DriverManager.getDriver().findElementById(mobileElement);
  ...
  protected void scrollClickAndroid(String scrollableListId, String selectionText) {
    ((AndroidDriver<WebElement>) DriverManager.getDriver()).findElementByAndroidUIAutomator(
